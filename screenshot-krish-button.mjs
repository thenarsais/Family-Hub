...
await page.setViewportSize({ width: 1280, height: 1200 }); // tall to see full card
...
// Scroll to Krish card and capture full card including button
...
await page.screenshot({ path: path.join(__dirname, 'krish-card-with-button.png') });
