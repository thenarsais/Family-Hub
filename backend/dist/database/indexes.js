...
exports.indexOptimizations = exports.recommendedIndexes = void 0;
exports.generateCreateIndexSQL = generateCreateIndexSQL;
exports.getIndexSQL = getIndexSQL;
exports.getIndexMonitoringQueries = getIndexMonitoringQueries;
/**
...
function generateCreateIndexSQL() {
    return exports.recommendedIndexes.map((index) => {
 ...
 */
function getIndexSQL(tableName) {
    const indexes = tableName
        ? exports.recommendedIndexes.filter((i) => i.table === tableName)
        : exports.recommendedIndexes;
 ...
 */
function getIndexMonitoringQueries() {
    return {
        missingIndexes: `
...
exports.default = {
    recommendedIndexes: exports.recommendedIndexes,
    generateCreateIndexSQL,
    getIndexSQL,
    indexOptimizations: exports.indexOptimizations,
