...
| Database | **Supabase managed Postgres**, prod project. Only work is applying migrations 001–019 + the learning & trivia seeds. |
...
2. Apply migrations **001 → 019** in order (the same one-off `pg` script used
